package com.fahemaSultana.uniclubz.activity.signUp;
...
public class Student_Profile extends AppCompatActivity {
    ...
    public void settingProfile(View view) {
        Intent profilesettings = new Intent(Student_Profile.this, com.fahemaSultana.uniclubz.activity.signUp.profilesettings.class);
        Bundle bundleforsignup = getIntent().getExtras();
