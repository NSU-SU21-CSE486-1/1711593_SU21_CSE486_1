package com.fahemaSultana.project03.signUp;
...
public class Student_Profile extends AppCompatActivity {
    ...
    public void settingProfile(View view) {
        Intent profilesettings = new Intent(Student_Profile.this, com.fahemaSultana.project03.signUp.profilesettings.class);
        Bundle bundleforsignup = getIntent().getExtras();
