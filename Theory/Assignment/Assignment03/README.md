...
<p>Here users can add Personal Information . </p>
...
<p>
  After clicking on the Submit button a toast message will be shown to enter university.
</p>
...
<h4>Figure 02 : Personal Information tab Screen with toast message</h4>

<hr>

<h2>University Affiliantion Tab Show a List of Universities</h2>

<p>Here, users can add multiple Universities. </p>
...
<h4>Figure 03: University Tab with show a list of university which is added</h4>
<p> Here, users can add multiple Universities , Study level and department by clicking on the floating action button . After clicking on the floating action button it will show an add university dialogue screen, where users can add multiple universities. </p>
...
<p>Here users can add phone numbers based on tags.</p>
...
<h4>Figure 04:Empty Phone Numbers tab Screen with toast message</h4>

<p>without entering any phone number. If the user presses the submit button, it will show a toast message asking them to enter  phone numbers. After pressing the floating action button, it will go to the add phone number dialogue screen to add the phone number.
</p>
...
<h4>Figure 05: PhoneNumbers Tab with phone number list </h4>

<hr>

<h2> Show Added MemberList  </h2>

<p> Users can add members by clicking on the submit button which is shown below the tab layout . After pressing the submit button it will go to another activity where it will show a list of members. </p> 
...
<h4>Figure 06: Show member list screen</h4>

<p> Added another members to see the list , After pressing view members button it will show the User list. </p>
...
<h4>Figure 07: Show member list screen</h4>

<p> If a user clicks on any member in the member list, it will show a toast message where the member's details will be shown. </p>
...
<h4>Figure 08: Show member list screen with clickable toast message</h4>


<img src="https://github.com/NSU-SU21-CSE486-1/1711593_SU21_CSE486_1/blob/main/Theory/Assignment/Assignment03/Screen%20Shots%20and%20Records%20of%20Project03/Screenshot_2021-09-09-23-37-24-596_com.fahemaSultana.Project03.jpg" width="200" height="400"/>
